package com.smarttech.SmartRH.AppResouces.Exceptions;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<MyErrorDetail> departmentException(DepartementException de, WebRequest wr){
    ...
    public ResponseEntity<MyErrorDetail> invalidMethodArgumentExceptionHandler(MethodArgumentNotValidException error ){
        ...
        err.setMessage(" Please pass the valid arguments.");
