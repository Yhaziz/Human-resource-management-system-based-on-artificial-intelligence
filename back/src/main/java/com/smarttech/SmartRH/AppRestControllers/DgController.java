...
public class DgController {
    ...
    ////////// Platform Config
    @GetMapping("/config")
    public ResponseEntity<PlatformConfigDto> getConfig(){
        PlatformConfigDto platformConfigDto = new PlatformConfigDto();
        platformConfigDto.setAiFeature(platformConfig.isAiFeature());
        platformConfigDto.setSmsFeature(platformConfig.isSmsFeature());
        platformConfigDto.setSmsUsername(platformConfig.getSmsUsername());
        platformConfigDto.setSmsPassword(platformConfig.getSmsPassword());
        platformConfigDto.setApiKey(platformConfig.getApiKey());
        platformConfigDto.setModel(platformConfig.getModel());
        platformConfigDto.setTemperature(platformConfig.getTemperature());

        return new ResponseEntity<PlatformConfigDto>(platformConfigDto, HttpStatus.OK);
    }

    @PutMapping("/config")
    public ResponseEntity<PlatformConfigDto> updateConfig(@RequestBody PlatformConfigDto dto) throws UserException {
        platformConfig.setAiFeature(dto.isAiFeature());
        platformConfig.setSmsFeature(dto.isSmsFeature());
        platformConfig.setSmsUsername(dto.getSmsUsername());
        platformConfig.setSmsPassword(dto.getSmsPassword());
        platformConfig.setApiKey(dto.getApiKey());
        platformConfig.setModel(dto.getModel());
        platformConfig.setTemperature(dto.getTemperature());
        PlatformConfigDto platformConfigDto = new PlatformConfigDto();
        platformConfigDto.setAiFeature(platformConfig.isAiFeature());
        platformConfigDto.setSmsFeature(platformConfig.isSmsFeature());
        platformConfigDto.setSmsUsername(platformConfig.getSmsUsername());
