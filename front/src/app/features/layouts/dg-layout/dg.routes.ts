...
export const DG_ROUTES: Routes = [
  ...
  {
    path: 'dashboard',
    loadComponent: () => import('../../components/dg/dashboard/dashboard.component').then((c) => c.DashboardComponent)
  },
  {
    path: 'departements',
  ...
  {
    path: 'paramètres',
    loadComponent: () => import('../../components/dg/parametres/parametres.component').then((c) => c.ParametresComponent)
  }
];
