...
class EmblaCarouselDirective {
    ...
    scrollTo(...args) {
        this.ngZone.runOutsideAngular(() => { var _a; return (_a = this.emblaApi) === null || _a === void 0 ? void 0 : _a.scrollTo(...args); });
    }
    scrollPrev(...args) {
        this.ngZone.runOutsideAngular(() => { var _a; return (_a = this.emblaApi) === null || _a === void 0 ? void 0 : _a.scrollPrev(...args); });
    }
    scrollNext(...args) {
        this.ngZone.runOutsideAngular(() => { var _a; return (_a = this.emblaApi) === null || _a === void 0 ? void 0 : _a.scrollNext(...args); });
    }
    reInit() {
        if (!this.emblaApi) {
            return;
        ...
        this.ngZone.runOutsideAngular(() => {
            var _a;
            (_a = this.emblaApi) === null || _a === void 0 ? void 0 : _a.reInit(this.storedOptions, this.storedPlugins);
        });
    }
    /**
