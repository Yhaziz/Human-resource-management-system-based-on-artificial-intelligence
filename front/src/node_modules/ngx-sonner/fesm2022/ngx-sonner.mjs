...
import { signal, input, Component, ChangeDetectionStrategy, booleanAttribute, Pipe, computed, effect, untracked, ViewChild, inject, PLATFORM_ID, numberAttribute, ViewEncapsulation } from '@angular/core';
...
class LoaderComponent {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.1.3", ngImport: i0, type: LoaderComponent, deps: [], target: i0.ɵɵFactoryTarget.Component }); }
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "17.1.3", type: LoaderComponent, isStandalone: true, selector: "ngx-sonner-loader", inputs: { isVisible: { classPropertyName: "isVisible", publicName: "isVisible", isSignal: true, isRequired: true, transformFunction: null } }, ngImport: i0, template: `
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "17.1.3", ngImport: i0, type: LoaderComponent, decorators: [{
            type: Component,
            args: [{
...
class ToastPositionPipe {
    transform(toasts, index, position) {
        return toasts.filter(toast => (!toast.position && index === 0) || toast.position === position);
    }
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.1.3", ngImport: i0, type: ToastPositionPipe, deps: [], target: i0.ɵɵFactoryTarget.Pipe }); }
    static { this.ɵpipe = i0.ɵɵngDeclarePipe({ minVersion: "14.0.0", version: "17.1.3", ngImport: i0, type: ToastPositionPipe, isStandalone: true, name: "toastPosition" }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "17.1.3", ngImport: i0, type: ToastPositionPipe, decorators: [{
            type: Pipe,
            args: [{ name: 'toastPosition', standalone: true }]
        }] });
...
class AsComponentPipe {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.1.3", ngImport: i0, type: AsComponentPipe, deps: [], target: i0.ɵɵFactoryTarget.Pipe }); }
    static { this.ɵpipe = i0.ɵɵngDeclarePipe({ minVersion: "14.0.0", version: "17.1.3", ngImport: i0, type: AsComponentPipe, isStandalone: true, name: "asComponent" }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "17.1.3", ngImport: i0, type: AsComponentPipe, decorators: [{
            type: Pipe,
            args: [{ name: 'asComponent', standalone: true }]
        }] });
...
class IsStringPipe {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.1.3", ngImport: i0, type: IsStringPipe, deps: [], target: i0.ɵɵFactoryTarget.Pipe }); }
    static { this.ɵpipe = i0.ɵɵngDeclarePipe({ minVersion: "14.0.0", version: "17.1.3", ngImport: i0, type: IsStringPipe, isStandalone: true, name: "isString" }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "17.1.3", ngImport: i0, type: IsStringPipe, decorators: [{
            type: Pipe,
            args: [{ name: 'isString', standalone: true }]
        }] });
    ...
    constructor() {
        ...
        effect(() => {
            if (this.toast().updated) {
                ...
                this.remainingTime =
                    this.toast().duration ?? this.duration() ?? TOAST_LIFETIME$1;
                this.startTimer();
            }
        });
        effect(onCleanup => {
...
export { NgxSonnerToaster, SwipeStateTypes, toast, toastState };
