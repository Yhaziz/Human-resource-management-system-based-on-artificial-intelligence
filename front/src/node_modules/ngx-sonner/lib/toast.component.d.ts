...
export declare class ToastComponent implements AfterViewInit, OnDestroy {
    ...
    _classes: import("@angular/core").InputSignal<ToastClassnames>;
    ...
    toastRef: ElementRef<HTMLLIElement>;
    classes: any;
